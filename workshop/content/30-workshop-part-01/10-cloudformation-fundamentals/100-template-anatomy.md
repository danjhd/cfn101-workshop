...
A stack is a deployment of a CloudFormation template. You can create multiple stacks from the same CloudFormation template allowing to very easily create identical environments. A stack contains a collection of AWS resources that you can manage as a single unit. All the resources in a stack are defined by the stack's AWS CloudFormation template.
